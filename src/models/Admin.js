...
const Admin = sequelize.define('Admin', {
  ...
  role: {
    ...
    defaultValue: 'doctor', // Changed default to 'doctor'
    validate: {
      isIn: [['doctor', 'secretary']] // Only allow 'doctor' or 'secretary' roles
    },
    field: 'role'
  },
  image: {
    type: DataTypes.STRING(255),
    allowNull: true,
    comment: 'Admin profile image filename with extension',
    field: 'image'
  },
  is_active: {
  ...
  supervisor_id: {
    type: DataTypes.INTEGER,
    allowNull: true,
    comment: 'Foreign key to reference the supervising doctor this secretary is assigned to',
    field: 'supervisor_id',
    references: {
      model: 'admins',
      key: 'user_id'
...
// Method to match admin entered password to hashed password in database
