 ...
 * 
 * This module provides reusable functions for handling image uploads with customizable
 * folder names and compression ratios. It can be used in various parts of the application
 * including user registration, profile updates, and other image upload scenarios.
 */
...
const uploadMultipleImages = async (req, res, options = {}) => {
  // Explicitly define the default options for multiple images
